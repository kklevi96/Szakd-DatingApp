        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId_A = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    UserId_B = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Compatibilities_AspNetUsers_UserId_A",
                        column: x => x.UserId_A,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Compatibilities_AspNetUsers_UserId_B",
                        column: x => x.UserId_B,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HobbyUsers", x => new { x.UserId, x.HobbyId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Compatibilities_UserId_B",
                table: "Compatibilities",
                column: "UserId_B");
